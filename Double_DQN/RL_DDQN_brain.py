...
class DoubleDQN:
    ...
    def store_transition(self, s, a, r, s_):
        ...
        s = s.reshape((self.n_actions,))
        s_ = s_.reshape((self.n_actions,))
    ...
    def choose_action(self, observation):
        ...
        state = observation.reshape((self.n_actions,))
        ...
        if not hasattr(self, 'q'):  # record action value it gets
            self.q = []
            self.running_q = 0
        self.running_q = self.running_q*0.99 + 0.01 * np.max(prob)
